  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // Filter books by genre "education"
        const educationBooks = allBooks.filter(book => book.genre.toLowerCase() === 'education');
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="main-content">
        <h1 className="text-center" style={{ fontSize: '36px', marginTop: '20px' }}>Entrance Exam Books</h1>
