...
const NonFiction = () => {
    ...
    useEffect(() => {
        // Fetch all books and filter by genre 'non-fiction'
        axios.get('http://localhost:4000/item')
            .then((response) => {
                const allBooks = response.data;
                const nonFictionBooks = allBooks.filter(book => book.genre.toLowerCase() === 'non-fiction');
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="main-content">
                <h1 className="text-center" style={{ fontSize: '36px', marginTop: '20px' }}>Non-Fiction Books</h1>
